...
Revision ID: 1e48df34b6b4
Revises: None
Create Date: 2026-07-11 17:38:44.759209
...
def upgrade() -> None:
    ...
    sa.Column('plan_tier', sa.Enum('STARTER', 'PROFESSIONAL', 'ENTERPRISE', name='plantier', native_enum=False), nullable=False),
    ...
    with op.batch_alter_table('invitations', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_invitations_invited_by'), ['invited_by'], unique=False)
    ...
    with op.batch_alter_table('document_chunks', schema=None) as batch_op:
        ...
        batch_op.create_index('idx_document_chunks_embedding', ['embedding'], unique=False, postgresql_using='hnsw', postgresql_ops={'embedding': 'vector_cosine_ops'})
        batch_op.create_index('idx_document_chunks_search_vector', ['search_vector'], unique=False, postgresql_using='gin')
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('document_chunks', schema=None) as batch_op:
        batch_op.drop_index('idx_document_chunks_search_vector')
        batch_op.drop_index('idx_document_chunks_embedding')
    ...
    with op.batch_alter_table('invitations', schema=None) as batch_op:
        ...
        batch_op.drop_index(batch_op.f('ix_invitations_invited_by'))
