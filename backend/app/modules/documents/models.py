...
class Document(TenantBaseModel):
    ...
    status: Mapped[str] = mapped_column(String(50), default="PENDING") # PENDING, PARSING, ACTIVE, ERROR
    ...
    def __repr__(self) -> str:
        return f"<Document name={self.name} status={self.status} tenant={self.tenant_id}>"
