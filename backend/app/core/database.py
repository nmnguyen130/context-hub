...
from sqlalchemy.orm import DeclarativeBase, Mapped, declared_attr, mapped_column, with_loader_criteria, Session
...
def _add_tenant_filter(execute_state):
    ...
    skip_tenant_filter = execute_state.execution_options.get("skip_tenant_filter", False)
